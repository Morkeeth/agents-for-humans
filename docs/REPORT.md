...
- **199** pytest tests (re-derived from `tests/test_*.py`).

## VERIFIED

| Claim | Command |
|-------|---------|
| Tests | `python3 -m pytest -q` → 199 passed |
...
- Historical s22–s24 cold-clone hashes unchanged; do not carry 199 onto those tips.

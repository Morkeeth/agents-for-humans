...
- **362** pytest tests (re-derived from `tests/test_*.py`)

## VERIFIED

| Claim | Command |
|-------|---------|
| Tests | `python3 -m pytest -q` → 362 passed |
...
| Cold clone s30 | `/tmp/magnet-cold-s30` @ `7da6b5f` → 362 passed |
| Cold clone s31 | `/tmp/magnet-cold-s31` @ `1e57c56` → 362 passed · check-docs 15 PASS · JUDGE DEMO OK |

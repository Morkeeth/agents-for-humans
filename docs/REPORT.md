...
- **329** pytest tests (re-derived from `tests/test_*.py`)

## VERIFIED

| Claim | Command |
|-------|---------|
| Tests | `python3 -m pytest -q` → 329 passed |
...
| Cold clone s30 | `/tmp/magnet-cold-s30` @ `7da6b5f` → 329 passed |
| Cold clone s31 | `/tmp/magnet-cold-s31` @ `1e57c56` → 329 passed · check-docs 15 PASS · JUDGE DEMO OK |

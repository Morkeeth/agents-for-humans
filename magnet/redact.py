...
# Assembled at runtime so this source file itself never contains a live match
# (found 2026-09-06: literal PEM / aws_secret strings in tests went RED).
...
# these markers are allowlisted only as whole words/phrases (not substrings of keys).
...
def _line_is_example(line: str) -> bool:
    """Allowlist only when an example marker is a clear word/phrase, not a key substring."""
    low = line.lower()

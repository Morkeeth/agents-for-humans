...
SCENARIOS: tuple[PredScenario, ...] = (
    ...
    PredScenario(
        ...
        "prediction-held",
        latest_value=3,
        note="Slice 56: -twenty percent is fall; 20% of pop 5 ≡ Δ−1",
    ),
    PredScenario(
        "minus_twenty_percent_missed",
        "-twenty percent",
        "helped",
        1,
        5,
        "prediction-missed",
        latest_value=4,
        note="THE LIE: bare-percent default invented rise/held on helped",
    ),
    PredScenario(
        "minus_word_percent_abs_missed",
        ...
        "prediction-missed",
        latest_value=0,
        note="absolute −20 invents held; true 20% of pop 5 is −1",
    ),
    PredScenario(
        "plus_twenty_percent_holds",
        "+twenty percent",
        "helped",
        1,
        5,
        "prediction-held",
        latest_value=4,
        note="+twenty percent rise; 20% of pop 5 ≡ Δ+1",
    ),
    PredScenario(
        "word_arrow_holds",
        "three → four",
        ...
        "prediction-held",
        latest_value=4,
        note="Slice 56: word arrow destination grades latest",
    ),
    PredScenario(
        "word_arrow_missed",
        "three → four",
        ...
        "prediction-missed",
        latest_value=3,
        note="THE LIE: word arrow unbound left no-direction",
    ),
    PredScenario(
        "word_ascii_arrow_missed",
        "three -> four",
        "unchanged",
        0,
        5,
        "prediction-missed",
        latest_value=3,
        note="ascii -> word arrow destination",
    ),
    PredScenario(
        "word_arrow_zero_missed",
        "one → zero",
        "hurt",
        -1,
        5,
        "prediction-missed",
        latest_value=1,
        note="word arrow to zero destination",
    ),
    # Slice 57 — word exactly / falls-to targets
    PredScenario(
        "exactly_four_holds",
        "exactly four",
        "unchanged",
        ...
        "prediction-held",
        latest_value=4,
        note="Slice 57: word exactly destination grades latest",
    ),
    PredScenario(
        "exactly_four_missed",
        "exactly four",
        ...
        "prediction-missed",
        latest_value=3,
        note="THE LIE: exactly alone was flat → invents held at any latest",
    ),
    PredScenario(
        "exactly_twenty_missed",
        "exactly twenty",
        "unchanged",
        0,
        20,
        "prediction-missed",
        latest_value=19,
        note="tens-word exactly twenty destination",
    ),
    PredScenario(
        "falls_to_four_holds",
        "falls to four",
        ...
        "prediction-held",
        latest_value=4,
        note="word falls-to destination",
    ),
    PredScenario(
        "falls_to_four_missed",
        "falls to four",
        "hurt",
        -1,
        5,
        "prediction-missed",
        latest_value=1,
        note="THE LIE: fall direction invents held off the named level",
    ),
    PredScenario(
        "reaches_five_missed",
        "reaches five",
...
def run_pred_demo() -> str:
    ...
    if embarrass >= 1 and magnet_ok == total:
        lines.append(
            ...
            "(Slice 55). `-twenty percent` / `minus twenty percent` are "
            "fall — never invent rise/held on helped (Slice 56). word "
    ...
    lines += [
        ...
        "  repro      magnet adopt skill x '-twenty percent' --probe demo-pass-rate --reset",
        "  repro      magnet adopt skill x 'minus twenty percent' --probe demo-pass-rate --reset",
        "  repro      magnet adopt skill x 'three → four' --probe demo-pass-rate --reset",
        "  repro      magnet adopt skill x 'three -> four' --probe demo-pass-rate --reset",
        "  repro      magnet adopt skill x 'exactly four' --probe demo-pass-rate --reset",
